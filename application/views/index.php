...
<script type="text/javascript" src="<?php echo base_url(); ?><?php echo base_url(); ?>js/jquery.min.js"></script>
<script type="text/javascript" src="<?php echo base_url(); ?><?php echo base_url(); ?>js/ddsmoothmenu.js">
...
<div id="templatemo_wrapper">
    ...
    <?php if (isset($content_page)) { ?>
        <?php if ($content_page =="Home_content") { ?>
